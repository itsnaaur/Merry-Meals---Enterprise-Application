           ...
           <!--Start end if -->
            ...
            <nav id="fh5co-menu-wrap" role="navigation">
                    <ul class="sf-menu" id="fh5co-primary-menu">
                        <li class="active">
                            <a href="{{ route('partner#index') }}" style="color: #000;"><strong>Home</strong></a>
                        </li>
                        <li>
                          <a href="#" class="fh5co-sub-ddown" style="color: #000;"><strong>Menu</strong></a>
                          <ul class="fh5co-sub-menu">
                              <li><a href="{{ route('partner#createMenu') }}" style="color: #000;"><strong>Create Menu</strong></a></li>
                          </ul>
                      </li>
                        ...
                        <li><a href="/about" style="color: #000;"><strong>About</strong></a></li>
                         <li><a href="/contact" style="color: #000;"><strong>Contact</strong></a></li>
                          ...
                          <ul class="dropdown-menu dropdown-menu-end">
                              <li><a class="dropdown-item" href="{{ route('partner#updateProfile', Auth()->user()->id) }}" style="color: #000;"><strong>Update </strong></a></li>
                              <li><a class="dropdown-item" href="{{ route('order#AllOrderForPartner', Auth()->user()->id) }}" style="color: #000;"><strong>Orders</strong> </a></li>
                              <li>
                                  <a class="dropdown-item" href="#">
                                      <form action="{{ route('logout') }}" method="post">
                                          @csrf
                                          <button type="submit" class="btn pt-0 pb-1 px-0 nav-link text-dark" style="button:focus { outline: none; }" style="color: #0e6655;" >  <i class="fas fa-sign-out-alt" ></i><strong> Logout </strong> </button>
                                      </form>
                                  </a>
                              </li>
                          </ul>
