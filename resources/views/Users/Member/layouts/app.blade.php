           ...
           <!--Start end if -->
            ...
            <nav id="fh5co-menu-wrap" role="navigation">
                    <ul class="sf-menu" id="fh5co-primary-menu">
                        <li class="active">
                            <a href="{{ route('member#index') }}" style="color: #000;"><strong>Home</strong></a>
                        </li>
                        <li><a href="{{ route('member#viewAllMenu') }}" style="color: #000;"><strong>Menu</strong></a></li>
                        ...
                        <li><a href="/about" style="color: #000;"><strong>About</strong></a></li>
                         <li><a href="/contact" style="color: #000;"><strong>Contact</strong></a></li>
                          ...
                          style="
                                padding: 12px 16px;" style="color: #000;">
                              <strong>{{ Auth()->user()->name }}</strong>
                          </button>
                          <ul class="dropdown-menu dropdown-menu-end">
                              <li><a class="dropdown-item" href="{{ route('member#updateProfile', Auth()->user()->id) }}" style="color: #000;"><strong>Update</strong> </a></li>
                              <?php 
                                    $order_id = DB::table('orders')->where('user_id',Auth()->user()->id)->value('id');
                              ?>
                              @if($order_id != null)
                              <li><a class="dropdown-item" href="{{ route('order#showOrderDelivery', Auth()->user()->id) }}" style="color: #000;"><strong>My Order</strong></a></li>
                              @endif
                              ...
                              <li>
                                  <a class="dropdown-item" href="#">
                                      <form action="{{ route('logout') }}" method="post">
                                          @csrf
                                          <button type="submit" class="btn pt-0 pb-1 px-0 nav-link text-dark" style="button:focus { outline: none; }" >  <i class="fas fa-sign-out-alt" style="color: #000;"></i> <strong> Logout </strong></button>
                                      </form>
                                  </a>
                              </li>
                          </ul>
